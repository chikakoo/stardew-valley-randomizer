...
public class ItemList
{
    ...
    public static void Initialize()
    {
        ...
        { 
            ...
            { ObjectIndexes.Moss.GetId(), new ResourceItem(ObjectIndexes.Moss, 1, new Range(1, 5)) { DifficultyToObtain = ObtainingDifficulties.LargeTimeRequirements } },
            ...
            { ObjectIndexes.SeaJelly.GetId(), new Item(ObjectIndexes.SeaJelly.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
            { ObjectIndexes.CaveJelly.GetId(), new Item(ObjectIndexes.CaveJelly.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
            { ObjectIndexes.RiverJelly.GetId(), new Item(ObjectIndexes.RiverJelly.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
            ...
            { ObjectIndexes.FireQuartz.GetId(), new Item(ObjectIndexes.FireQuartz.GetId(), ObtainingDifficulties.LargeTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 2) } },
            ...
            { ObjectIndexes.MagmaGeode.GetId(), new Item(ObjectIndexes.MagmaGeode.GetId(), ObtainingDifficulties.LargeTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 2) } },
            { ObjectIndexes.OmniGeode.GetId(), new Item(ObjectIndexes.OmniGeode.GetId(), ObtainingDifficulties.LargeTimeRequirements) },

            { ObjectIndexes.Aquamarine.GetId(), new Item(ObjectIndexes.Aquamarine.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
            { ObjectIndexes.Amethyst.GetId(), new Item(ObjectIndexes.Amethyst.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
            { ObjectIndexes.Emerald.GetId(), new Item(ObjectIndexes.Emerald.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
            { ObjectIndexes.Ruby.GetId(), new Item(ObjectIndexes.Ruby.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
            { ObjectIndexes.Topaz.GetId(), new Item(ObjectIndexes.Topaz.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
            { ObjectIndexes.Jade.GetId(), new Item(ObjectIndexes.Jade.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
            { ObjectIndexes.Diamond.GetId(), new Item(ObjectIndexes.Diamond.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
            ...
            { ObjectIndexes.PurpleMushroom.GetId(), new Item(ObjectIndexes.PurpleMushroom.GetId(), ObtainingDifficulties.LargeTimeRequirements) },
