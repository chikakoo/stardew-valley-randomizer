...
public class SeedItem : Item
{
    ...
    public string Description
    {
        get
        {
            ...
            string flowerString = IsFlowerSeed ? $"{Globals.GetTranslation("crop-tooltip-flower")} " : "";
    ...
    {
        get => CropGrowthInfo.Seasons.Cast<Seasons>().ToList();
    }
    public bool IsFlowerSeed
    {
        get 
        {
            if (ItemList.Items.TryGetValue(CropId, out Item item) &&
                item is CropItem cropItem)
            {
                return cropItem.IsFlower;
            }
            return false;
        }
    }
